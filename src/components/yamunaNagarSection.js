...
const yamunaSection = () => {
    return (
        <div className="yamuna-section d-flex container-fluid flex-wrap">
            {/* <div className="text-section col-lg-7 col-md-12 d-flex flex-column justify-content-center">
        <h2 className="fw-bold mb-3">DPS, Yamuna Nagar</h2>
        <h4 className="mb-4">The Best CBSE Boarding School in North India</h4>
        <p className="mb-4">
          The environment at DPS Yamuna Nagar, one of the best boarding schools in Haryana, is highly nurturing, caring, and aims towards providing every child with opportunities to develop their talents as well as achieve their full academic potential. Our objective at the day boarding school is to make students' life fun, safe, and rewarding, and help them achieve independence and maturity. We take great pride in providing the best amenities to all our students. We focus on every element required for the holistic growth of our wards.
        </p>
        <p className="mb-4">
          Teachers at the day boarding school in Yamuna Nagar take 100% responsibility for the holistic development of children. Our landmark day boarding school provides unmatched ambiance and a highly motivating learning environment to the students. Besides providing high-quality education, we focus on the overall growth and development of the students. Students from different backgrounds and cultures come together and thrive as their differences are embraced and celebrated by our vibrant community of boarders. The school offers boarding facilities to students from multiple nationalities, making it one of the best residential schools in India. <span className="text-primary">Read More</span>
        </p>
      </div> */}
